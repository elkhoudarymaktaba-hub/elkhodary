      ...
      {selectedPage ? (
        <div className="lg:col-span-3 grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
          ...
          <div className="space-y-4">
            ...
            {/* أدوات الإضافة للكتل بالأسفل (Add Block Row) */}
            <div className="bg-[#FBEBCB]/15 border border-[#E7DCC2] p-4 rounded-[16px] flex flex-wrap items-center justify-center gap-3">
              <span className="text-xs font-bold text-ink font-arabic ml-2">إضافة كتلة جديدة:</span>
              {selectedPage?.slug === 'box-builder' ? (
                <>
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    onClick={() => addBlock('box_builder_stages')}
                    className="px-4 py-2 bg-[#2E7FD9] hover:bg-[#1B4F8A] text-white text-xs font-bold rounded-[24px] transition-all font-arabic shadow-sm"
                  >
                    ⚙️ + قسم مراحل صانع الصناديق
                  </button>
                </>
                ...
                <>
                  <button
                    type="button"
                    onClick={() => addBlock('about_header')}
                    className="px-4 py-2 bg-coral hover:bg-coral-deep text-white text-xs font-bold rounded-[24px] transition-all font-arabic shadow-sm"
                  >
                    📖 + ترويسة من نحن
                  </button>
                  <button
                    type="button"
                    onClick={() => addBlock('about_story')}
                    className="px-4 py-2 bg-coral hover:bg-coral-deep text-white text-xs font-bold rounded-[24px] transition-all font-arabic shadow-sm"
                  >
                    📖 + قصة نجاح من نحن
                  </button>
                ...
                <>
                  ...
                  <button
                    type="button"
                    onClick={() => addBlock('contact_section')}
                    className="px-4 py-2 bg-white hover:bg-amber hover:text-white border border-slate-200 text-xs font-bold rounded-[24px] text-slate-700 transition-all font-arabic"
                  >
                    + تفاصيل واتصال (Contact Us)
                  </button>
                  <button
                    type="button"
