    ...
    <div className="space-y-12">
          ...
          <div className="space-y-4">
            ...
            {cleanDescription && (
              <div className="space-y-2">
                <h3 className="font-extrabold text-xs text-ink font-arabic">وصف المنتج:</h3>
                <p className="text-ink-soft/75 text-sm leading-relaxed font-medium font-arabic">
                  {cleanDescription}
                </p>
              </div>
            )}
      ...
      <div className="bg-white rounded-card shadow-brand border border-brand-border p-6 md:p-10 text-right space-y-8 animate-fade-in" dir="rtl">
        <div className="border-r-4 border-amber pr-3">
          ...
          <p className="text-xs text-slate-500 font-arabic mt-1">تجارب حقيقية لعملائنا بعد تجربة this المنتج</p>
        </div>
